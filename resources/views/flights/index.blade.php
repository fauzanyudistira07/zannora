...
@section('content')
    <section class="grid gap-6 lg:grid-cols-[320px_1fr]">
        <aside class="portal-card h-fit">
            <h1 class="font-heading text-3xl font-bold text-[#0f3f78]">Search Result</h1>
                    ...
                    <article class="portal-card transition hover:brightness-[1.02]">
                        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-3xl font-bold text-[#0f3f78]">Rp{{ number_format((float) $flight->price, 0, ',', '.') }}</p>
                                <a href="{{ route('flights.show', $flight) }}" class="portal-btn-blue mt-2 px-4 py-2">
                                    Select
                                </a>
                            </div>
                        </div>
