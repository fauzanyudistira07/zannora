        ...
        <article class="admin-card">
            <div class="admin-section-head">
                <div>
                    ...
                    <p class="admin-section-copy">Detail profil, booking, passenger, dan aktivitas pembayaran user.</p>
                </div>
            ...
            <div class="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div>
                    ...
                    <p class="break-all font-semibold text-slate-800">{{ $user->email }}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="font-semibold text-slate-800">{{ $user->roleLabel() }}</p>
                </div>
                <div>
                    <p class="text-sm text-slate-500">Employee ID</p>
                    <p class="font-semibold text-slate-800">{{ $user->employee_id ?: '-' }}</p>
                </div>
                <div>
                    <p class="text-sm text-slate-500">Department</p>
                    <p class="font-semibold text-slate-800">{{ $user->department ?: '-' }}</p>
                </div>
                <div>
                    <p class="text-sm text-slate-500">Job Title</p>
                    <p class="font-semibold text-slate-800">{{ $user->job_title ?: '-' }}</p>
                </div>
            </div>
        </article>
