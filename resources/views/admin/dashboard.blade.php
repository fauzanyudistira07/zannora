...
@section('content')
    <section class="space-y-6">
        ...
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <article class="admin-card-soft">
                <p class="text-sm text-slate-500">Backoffice Staff</p>
                <p class="mt-1 text-2xl font-bold text-slate-800">{{ $stats['total_staff'] }}</p>
            </article>
            <article class="admin-card-soft">
                <p class="text-sm text-slate-500">Managers</p>
                <p class="mt-1 text-2xl font-bold text-slate-800">{{ $stats['total_managers'] }}</p>
            </article>
            <article class="admin-card-soft">
                <p class="text-sm text-slate-500">Administrators</p>
                <p class="mt-1 text-2xl font-bold text-slate-800">{{ $stats['total_admins'] }}</p>
            </article>
            <article class="admin-card-soft">
                <p class="text-sm text-slate-500">Open Support Inbox</p>
                <p class="mt-1 text-2xl font-bold text-[#0f3f78]">{{ $stats['open_contact_messages'] }}</p>
            </article>
        </div>
        ...
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            <article class="admin-card-soft">
                ...
                <p class="mt-1 text-2xl font-bold text-amber-600">{{ $stats['pending_checkins'] }}</p>
            </article>
            <article class="admin-card-soft">
                <p class="text-sm text-slate-500">Active Add-Ons</p>
                <p class="mt-1 text-2xl font-bold text-[#0f3f78]">{{ $stats['active_addons'] }}</p>
            </article>
            <article class="admin-card-soft">
                <p class="text-sm text-slate-500">Open Change Requests</p>
                <p class="mt-1 text-2xl font-bold text-red-600">{{ $stats['open_change_requests'] }}</p>
            </article>
        </div>
        ...
        <article class="admin-card">
            <div class="mb-4 flex items-center justify-between">
                <h2 class="font-heading text-xl font-bold text-[#0f3f78]">Support Inbox</h2>
