...
@section('title', 'Admin Change Requests | Zannora')
        ...
        <form method="GET" class="admin-card space-y-5">
            <div class="admin-section-head">
                <div>
                    ...
                    <h2 class="admin-section-title">Refund & Change Queue</h2>
                    <p class="admin-section-copy">Kelola request refund, reschedule, perbaikan nama, dan cancel request dari customer.</p>
                </div>
