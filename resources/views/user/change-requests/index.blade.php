...
@section('title', 'Zannora | Service Requests')
@section('active', 'change-requests')

@section('content')
    <section class="space-y-6">
        <article class="portal-card">
            <p class="text-sm uppercase tracking-[0.25em] text-[#315b8c]">Post Booking Service</p>
            <h1 class="portal-fluid-title mt-1 font-heading font-bold text-slate-800">Refund & Change Request</h1>
            <p class="mt-2 text-slate-600">Ajukan refund, reschedule, perbaikan nama, atau cancel request dari booking yang memenuhi syarat.</p>
        </article>

        <div class="grid gap-6 xl:grid-cols-[1fr_420px]">
            <article class="portal-card">
                <h2 class="font-heading text-2xl font-bold text-[#0f3f78]">Buat Permintaan Baru</h2>
            ...
            <aside class="portal-card h-fit">
                <h2 class="font-heading text-2xl font-bold text-[#0f3f78]">Jenis Request</h2>
        ...
        <article class="portal-card">
            <h2 class="font-heading text-2xl font-bold text-[#0f3f78]">Riwayat Permintaan</h2>
            <div class="mt-4 space-y-3">
