...
@section('title', 'Zannora | Online Check-In')
    ...
    <section class="space-y-6">
        <article class="portal-card">
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div class="min-w-0">
                    <p class="text-sm uppercase tracking-[0.25em] text-[#315b8c]">Online Check-In</p>
        ...
        <article class="portal-card">
            <h2 class="font-heading text-2xl font-bold text-[#0f3f78]">Passenger Check-In Manifest</h2>
            <p class="mt-1 text-sm text-slate-600">Setiap passenger memiliki boarding pass dan QR sendiri. Jika passenger lebih dari satu, lakukan check-in per passenger.</p>
                    ...
                    <article class="portal-card-soft">
                        ...
                        @if (in_array($detail->boarding_status, ['checked_in', 'boarded'], true))
                            <div class="mt-4 grid gap-4 lg:grid-cols-[220px_1fr]">
                                <div class="rounded-xl border border-dashed border-slate-300 bg-white p-3 text-center">
                                    <img
