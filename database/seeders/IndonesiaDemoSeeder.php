...
class IndonesiaDemoSeeder extends Seeder
{
    ...
    protected function seedUsers(): array
    {
        $users = [
            ...
            'dewi.putri@zannora.com' => [
                'name' => 'Dewi Putri Maharani',
                'phone' => '081290001234',
                'password' => Hash::make('password'),
                'role' => 'user',
            ],
            'rafi.pratama@zannora.com' => [
                'name' => 'Rafi Pratama Saputra',
                'phone' => '081355551111',
                'password' => Hash::make('password'),
                'role' => 'user',
            ],
            'intan.lestari@zannora.com' => [
    ...
    protected function seedPassengers(array $users): array
    {
        $passengers = [
            ...
            [
                'key' => 'dewi_maharani',
                'user_email' => 'dewi.putri@zannora.com',
            ...
            [
                'key' => 'rafi_saputra',
                'user_email' => 'rafi.pratama@zannora.com',
            ...
            [
                'key' => 'intan_wibowo',
                'user_email' => 'intan.lestari@zannora.com',
